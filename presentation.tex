...
\begin{frame}
  ...
  \[f(\mathbf{x}, \mathbf{\theta}) = \ev{\mathcal{M}}{\psi\left( \mathbf{x}, \mathbf{\theta} \right)},\]
  where
  \[\ket{\psi\left( \mathbf{x}, \mathbf{\theta} \right)} = W\left( \mathbf{\theta} \right) U(\mathbf{x}) \ket{0}\]
  and
